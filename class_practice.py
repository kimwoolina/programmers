...
def search_post_by_username(username_to_check):
    ...
    if titles:
        print(f"List of post titles written by {username_to_check}: {titles}")
    else:
        print(f"There are no posts written by {username_to_check}.")
...
def search_post_by_keyword(keyword_to_check):
    ...
    for post in posts:
        if keyword_to_check in post.content:
            titles.append(post.title)
    if titles:
        print(f"List of post titles containing {keyword_to_check}: {titles}")
    else:
        print("No posts were found with the given keyword.")
